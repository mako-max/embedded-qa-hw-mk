...
US-100 у Trig/Echo-режимі (перемичка знята), нерухома плоска мішень у робочому
діапазоні датчика. Точна відстань не має значення; не рухайте датчик або мішень
протягом тесту. Тест виконує 3 серії по 10 вимірів без reboot між серіями.
